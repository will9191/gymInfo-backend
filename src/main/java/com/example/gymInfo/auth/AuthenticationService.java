...
import com.example.gymInfo.config.JwtService;
import com.example.gymInfo.token.Token;
import com.example.gymInfo.token.TokenRepository;
import com.example.gymInfo.token.TokenType;
import com.example.gymInfo.user.User;
import com.example.gymInfo.user.UserRepository;
